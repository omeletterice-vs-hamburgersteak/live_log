...
class FavoritesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create favorite" do
    assert_difference("Favorite.count") do
      post favorites_url, params: { favorite: { category: @favorite.category, memo: @favorite.memo, name: @favorite.name } }
    end
  ...
  test "should update favorite" do
    patch favorite_url(@favorite), params: { favorite: { category: @favorite.category, memo: @favorite.memo, name: @favorite.name } }
